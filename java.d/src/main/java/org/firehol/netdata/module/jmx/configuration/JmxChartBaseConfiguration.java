 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "dimensionType", defaultImpl = JmxChartConfiguration.class)
@JsonSubTypes({ @JsonSubTypes.Type(value = JmxChartConfiguration.class, name = "fixed"),
		@JsonSubTypes.Type(value = JmxDynamicChartConfiguration.class, name = "dynamic") })
@Getter
@Setter
public abstract class JmxChartBaseConfiguration {
